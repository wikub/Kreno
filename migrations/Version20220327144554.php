 ...
 */
final class Version20220327144554 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE commitment_contract DROP start, DROP finish');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE commitment_contract ADD start DATE NOT NULL, ADD finish DATE DEFAULT NULL');
